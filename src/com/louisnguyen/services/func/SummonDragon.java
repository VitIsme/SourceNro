            ...
            if (checkShenronBall(pl)) {
                ...
                if (Util.canDoWithTime(lastTimeShenronAppeared, timeResummonShenron)) {
                    ...
                    Service.gI().sendThongBao(pl,
                            "Vui lòng đợi " + (timeLeft < 2 ? timeLeft + " giây" : timeLeft / 500 + " phút") + " nữa");
                }
            }
        } else {
            ...
            case ConstNpc.SHENRON_1_2:
                switch (this.select) {
                    ...
                    case 1: // +1,5 ngọc
                        ...
                        break;
                    case 2: // +200 tr smtn
                        if (this.playerSummonShenron.nPoint.power < 210999999999L) {
                            Service.gI().addSMTN(this.playerSummonShenron, (byte) 2, 200000000, false);
                            break;
                        } else {
                            Service.gI().sendThongBao(playerSummonShenron, "Chúc mừng bạn nhận được cái nịt!!");
                        }
                        break;
