...
import com.louisnguyen.services.ChatGlobalService;
...
import com.louisnguyen.services.FlagBagService;
import com.louisnguyen.services.SkillService;
import com.louisnguyen.services.SubMenuService;
...
import com.louisnguyen.consts.ConstIgnoreName;
...
import static com.louisnguyen.services.func.Input.CHOOSE_LEVEL_BDKB;
import static com.louisnguyen.services.func.Input.NUMERIC;
...
public class Controller implements IMessageHandler {
        ...
        try {
            ...
            switch (cmd) {
                ...
                case -7:
                    ...
                    break;
                // case -74:
                // Service.gI().sendThongBaoOK(_session, "Vui lòng cập nhật phiên bản 1.0.0 tại
                // Trang chủ ngocrongxuan.com .Vui lòng không sử dụng phầm mềm thứ 3 hoặc
                // tools/Mod bên ngoài tránh bị xử phạt!!!");
                // break;
                ...
                case -29:
                    ...
                    break;
                // case -29:
                // Service.getInstance().sendThongBaoOK(session, "Vui lòng cập nhật phiên bản
                // 0.1 tại
                // Trang chủ ngocrongxuanha.com .Vui lòng không sử dụng phầm mềm thứ 3 hoặc
                // tools/Mod bên ngoài tránh bị xử phạt!!!");
                // break;
                case -30:
    ...
    public void login2(MySession session, Message msg) {
        Service.gI().sendThongBaoOK(session, "Đăng ký tài khoản tại Ngocrongxuanha.com!!!");
    }
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với sever Goku\n"
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player,
                "Máy chủ sẽ bảo trì định kì lúc 00h sáng để chạy ổn định mà không gặp\bcác lỗi Boss, Kẹt nick...\bChúc các bạn chơi vui vẻ!!!");
    }
