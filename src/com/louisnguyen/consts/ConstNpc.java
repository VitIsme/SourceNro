...
public class ConstNpc {
        ...
        public static final String HUONG_DAN_DOANH_TRAI = "Các bang hội hãy tập hợp đủ 3 thành viên để tham gia phó bản Doanh Trại\bCác thành viên phải tham gia bang hội đủ 1 ngày\bTiêu diệt Boss để nhận các vật phẩm giá trị như Ngọc Rồng, Hồng Ngọc, Vật phẩm\bcó sao pha lê\bNếu may mắn có thể nhận được vật phẩm 6 sao pha lê";

        public static final String HUONG_DAN_GIAI_CUU_MI_NUONG = "Các bang hội hãy tập hợp đủ 3 thành viên để lên đường giải cứu Mị nương\bCác thành viên phải tham gia bang hội đủ 1 ngày\bTiêu diệt quái và Mị nương để nhận các vật phẩm giá trị\bNếu may mắn sẽ nhận được cải trang Mị nương Vĩnh viễn";

        public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi ngày từ 20h đến 21h các hành tinh có Ngọc Rồng Sao Đen sẽ xảy ra 1 cuộc đại\b"
                        + "chiến\bNgười nào tìm thấy và giữ được Ngọc Rồng Sao Đen sẽ mang lại phần thưởng về cho bang của mình trong vòng 1 ngày\n"
                        + "Lưu ý mỗi bang chỉ có thể chiến hữu nhiều viên khác nhau, và nếu cùng loại sẽ\bđược cộng dồn.\b"
                        + "Có 2 cách để thắng:\b1)Giữ ngọc sao đen trên người 5 phút liên tục\b2) Sau 60 phút tham gia tàu sẽ đón về và đang giữ ngọc rồng sao đen trên người\n"
                        + "Các phần thưởng như sau\b1 sao đen: +21% sức đánh\b2 sao đen: +35%HP và KI\b3 sao đen: +35% hút HP\b4 sao đen: +35% phản sát thương\b5 sao đen: +14% giáp\b6 sao đen: +21% xuyên giáp\b7 sao đen: +14% né đòn\bCác phần thưởng không thể giao dịch cho người khác, có tác dụng khi nằm\btrong hành trang.";
        ...
        public static final String DAI_CHIEN_BANG_HOI = "Thời gian diễn ra Đại chiến Bang hội vào các khung giờ 19h30 - 23h59 hằng ngày\b"
                        + "Hạ gục người chơi khác hoặc mộc nhân để nhận điểm tích lũy Hồng Ngọc\b"
        ...
        public static final byte THO_NGOC = 54;
        ...
        public static final byte MI_NUONG = 77;
        ...
        public static final int CHUC_NANG_BANG_HOI = 534;

        public static final int HANG_SOI = 535;

        public static final int CHUC_NANG_BANG_HOI2 = 536;
        ...
        public static final int MENU_NANG_CAP_DO_TL = 506;
        public static final int MENU_DAP_DO = 507;
        public static final int PHAP_SU_TRANG_BI = 508;
        public static final int NANG_CAP_VAT_PHAM = 509;
        public static final int MENU_NANG_CAP_DO_HD = 510;
        public static final int MENU_NANG_CAP_3_DO_HD = 511;
        public static final int MENU_THANG_HOA_NGOC_BOI = 512;
        public static final int MENU_THANG_HOA_NGOC_BOI_DE_TU = 513;

        public static final int NANG_CAP_VAT_PHAM2 = 511;
        ...
        public static final int MENU_OPENED_GIAI_CUU_MI_NUONG = 545;
        ...
        public static final int XAC_NHAN_XOA_BANG_HOI = 517;

        public static final int MENU_MUA_CAPSULE1 = 519;
        public static final int BAN_NHIEU_THOI_VANG = 999;

        public static final int MENU_MUA_CAPSULE = 518;
