...
import com.louisnguyen.models.player.Enemy;
            ...
            if (rs.first()) {
                ...
                if (rs.getBoolean("ban")) {
                    ...
                    if (plInGame != null) {
                        ...
                        Service.getInstance().sendThongBaoOK(session, "Tài khoản của bạn hiện đang online trong server!!!");
                    } else {
                    }
                    ...
                    if (secondsPass < Manager.SECOND_WAIT_LOGIN) {
                        ...
                        if (!rs.first()) {
                            ...
                            try {
                                ...
                                if (MapService.gI().isMapDoanhTrai(mapId) || MapService.gI().isMapGiaiCuuMiNuong(mapId) || MapService.gI().isNguHanhSon(mapId) || MapService.gI().isMapBlackBallWar(mapId)
