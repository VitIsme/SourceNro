...
public class Player {
        ...
        if (!this.beforeDispose) {
            try {
                if (!iDMark.isBan()) {
                    ...
                    } else if (!isBoss && this.iDMark.isGoToKGHD()
                    ...
                    } else if (!isBoss && this.iDMark.isGoToCDRD()
                            && Util.canDoWithTime(this.iDMark.getLastTimeGoToKGHD(), 6000)) {
    ...
    private static final short[][] idOutfitFusion = {
            ...
            { 1271, 1272, 1273 }, // trai dat c2
            { 1277, 1278, 1279 }, // Namec c2
            { 1274, 1275, 1276 },// Xayda c2
    };
    ...
    public byte getEffFront() {
        ...
        if (this.inventory.itemsBody.get(8).isNotNullItem()) {
            if (this.inventory.itemsBody.get(8).template.id == (1980 + 7)) {
                return (byte) 210;
            }
        }
        ...
        if (effectSkill != null && effectSkill.isMonkey) {
            ...
            if (fusion.typeFusion == ConstPlayer.LUONG_LONG_NHAT_THE) {
                ...
                if (inventory != null && inventory.itemsBody.get(5).isNotNullItem()
                        && inventory.itemsBody.get(5).isThanZeno()) {
                ...
                switch (plAtt.playerSkill.skillSelect.template.id) {
                    ...
                    case Skill.ANTOMIC:
                        if (this.nPoint.voHieuChuong > 0) {
                            com.louisnguyen.services.PlayerService.gI().hoiPhuc(this, 0,
