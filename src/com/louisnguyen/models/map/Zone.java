...
import com.louisnguyen.models.player.Yajiro;
...
import com.louisnguyen.models.player.Referee;
                        ...
                        switch (itemType) {
                            ...
                            default:
                                switch (item.template.id) {
                                    case 362:
                                        Service.gI().sendThongBao(player, "Đây là hóa hoạch, không thể nhặt?");
                                        break;
                                    case 353:
                                    case 354:
                                    case 355:
                                    ...
                                    case 359:
                                        if(System.currentTimeMillis() >= NgocRongNamecService.gI().tOpenNrNamec) {
                                            if(player.idNRNM == -1){
                                                ...
                                                Service.gI().sendThongBao(player, "Bạn đang mang ngọc rồng trên người");
                                            }
                                        }else{
                                            Service.gI().sendThongBao(player, "Đây là hóa hoạch, không thể nhặt?");
                                        }
...
//            Logger.logException(MapService.class, e);
        ...
        if (!plInfo.isBoss && !plInfo.isPet &&!plInfo.isNewPet && !(plInfo instanceof Referee) & !(plInfo instanceof Yajiro)) {
