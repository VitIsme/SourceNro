...
import static com.louisnguyen.services.func.SummonDragon.SHENRON_1_STAR_WISHES_1;
import static com.louisnguyen.services.func.SummonDragon.SHENRON_1_STAR_WISHES_2;
import static com.louisnguyen.services.func.SummonDragon.SHENRON_SAY;
...
import com.louisnguyen.models.matches.pvp.DaiHoiVoThuatService;
import com.louisnguyen.models.mob.Mob;
import com.louisnguyen.models.npc.BXH;
...
import static com.louisnguyen.services.func.CombineServiceNew.PS_HOA_TRANG_BI;
...
public class NpcFactory {
                        ...
                        switch (select) {
                            case 0:
                                if (player.nPoint.power >= 80000000000L) {
                                    ...
                                    Service.gI().sendThongBao(player, "Yêu cầu đạt 80 Tỉ sức mạnh!!!");
                                    break;
                                }
                                return;
                        }
    ...
    ///////////////////////////////// NPC ĐẠI THIÊN
    ///////////////////////////////// SỨ/////////////////////////////////////////////////
    // public static Npc DaiThienSu(int mapId, int status, int cx, int cy, int
    // tempId, int avartar) {
    // return new Npc(mapId, status, cx, cy, tempId, avartar) {
    // public void chatWithNpc(Player player) {
    // String[] chat = {
                    ...
                    if (player.iDMark.isBaseMenu()) {
                        switch (select) {
                            ...
                            case 2:
                                ...
                                if (binhnuoc != null && binhnuoc.quantity > 0 && player.nPoint.power >= 80000000000L) {
    ...
    // public static Npc thanVuTru(int mapId, int status, int cx, int cy, int
    // tempId, int avartar) {
    // return new Npc(mapId, status, cx, cy, tempId, avartar) {
    // @Override
    // public void openBaseMenu(Player player) {
    ...
    // ConDuongRanDoc.POWER_CAN_GO_TO_CDRD) {
    ...
    // };
    // }
    // public static Npc osin(int mapId, int status, int cx, int cy, int tempId, int
    // avartar) {
    // return new Npc(mapId, status, cx, cy, tempId, avartar) {
    // @Override
    // public void openBaseMenu(Player player) {
    // if (canOpenNpc(player)) {
    // if (this.mapId == 50) {
    // this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi muốn đi đến Vùng Đất
    // của các Vị Thần ?",
    // "Đến \nHành Tinh Kaio", "Đến \nHành Tinh Bill", "Từ chối");
    // } else if (this.mapId == 154) {
    // this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ngươi muốn đi về Trái Đất
    // hay đi đến Thung Lũng Hủy Diệt?",
    // "Về \nSiêu Thị", "Đến\n Thung Lũng Hủy Diệt", "Đến\n Hành tinh\nNgục tù",
    // "Hướng dẫn");
    // } else if (this.mapId == 176) {
    // this.createOtherMenu(player, ConstNpc.BASE_MENU, "Ta có thể giúp ngươi trở về
    ...
    // this.createOtherMenu(player, ConstNpc.GO_UPSTAIRS_MENU, "Ta có thể giúp gì
    // cho ngươi ?",
    ...
    // ChangeMapService.gI().changeMap(player, this.map.mapIdNextMabu((short)
    // this.mapId), -1, this.cx, this.cy);
    // } else if (select == 1) {
    ...
    public static Npc BuMap(int mapId, int status, int cx, int cy, int tempId, int avartar) {
        return new Npc(mapId, status, cx, cy, tempId, avartar) {
            ...
            // createOtherMenu(player, ConstNpc.BASE_MENU,
            // "Ta được admin Ngọc Rồng Xuân Hạ đến đây để hỗ trợ các "
                                    ...
                                    this.createOtherMenu(player, 888,
                                            "Đây là danh hiệu mà ngươi có"
                                                    ...
                                                    + (player.lastTimeTitle3 > 0
                                                            ...
                                                            : ""),
                                            ("Danh hiệu \n VIP 1: "
                                                    + (player.isTitleUse == true ? "Bật" : "Tắt")),
                                            ("Danh hiệu \n Fan cứng: "
                                                    + (player.isTitleUse2 == true ? "Bật" : "Tắt")
                                                    + "\n"),
                                            ("Danh hiệu \n Bất bại: "
                                                    + (player.isTitleUse3 == true ? "Bật" : "Tắt")
                                                    + "\n"),
                                            "Từ chối");
                                    break;
                            }
                        ...
                        switch (select) {
                            ...
                            case 3:
                                if (player.getSession().actived && player.pointPvp < 1) {
                                    ...
                                    Service.gI().sendThongBao(player, "Bạn đã nhận quà thành viên rồi");
                                }
                        }
                ...
                switch (player.iDMark.getIndexMenu()) {
                    case ConstNpc.BAN_NHIEU_THOI_VANG:
                        ...
                        if (select == 0 && thoivang.quantity >= 1 && thoivang != null
                                && player.inventory.gold < 49_500_000_000L) {
                            thoivang.quantity -= 1;
                        ...
                        if (select == 1 && thoivang.quantity >= 5 && thoivang != null
                                && player.inventory.gold < 47_500_000_000L) {
                            thoivang.quantity -= 5;
                        ...
                        if (select == 1 && thoivang.quantity >= 10 && thoivang != null
                                && player.inventory.gold < 45_000_000_000L) {
                        ...
                        if (select == 1 && thoivang.quantity >= 19 && thoivang != null
                                && player.inventory.gold < 40_500_000_000L) {
                            ...
                            return;
                        } else if (player.inventory.gold > 40_500_000_000L) {
                            Service.gI().sendThongBao(player, "Số vàng sau khi bán vượt quá 50 tỷ");
                            return;
                        }
                        break;
                }
                ...
                switch (player.iDMark.getIndexMenu()) {
                    ...
                    case ConstNpc.BAN_NHIEU_THOI_VANG:
                        ...
                        if (select == 0 && thoivang.quantity >= 1 && thoivang != null
                            ...
                            Service.gI().sendThongBao(player, "Cần có đủ 1 Thỏi\nvàng để thực hiện");
                            return;
                        } else if (select == 0 && thoivang.quantity >= 1 && player.inventory.gold > 49_500_000_000L) {
                            Service.gI().sendThongBao(player, "Số vàng sau khi bán vượt quá 50 tỷ");
                            return;
                        }
                        if (select == 1 && thoivang.quantity >= 5 && thoivang != null
