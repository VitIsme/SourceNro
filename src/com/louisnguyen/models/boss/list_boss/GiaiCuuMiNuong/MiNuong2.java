 ...
 */
public class MiNuong2 extends Boss {

    protected Player playerAtt;

    public MiNuong2(Zone zone, int dame, int hp) throws Exception {
        super(-101, new BossData(
                "Mị nương", // name
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap caitrangmi2 = new ItemMap(this.zone, 860, 1, this.location.x,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
            caitrangmi2.options.add(new Item.ItemOption(50, 24));
            caitrangmi2.options.add(new Item.ItemOption(77, 32));
            caitrangmi2.options.add(new Item.ItemOption(117, 20));
            caitrangmi2.options.add(new Item.ItemOption(93, new Random().nextInt(3) + 4));
            Service.getInstance().dropItemMap(this.zone, caitrangmi2);
        }
    }
