...
public class QuyLao extends Boss {
    ...
    public void reward(Player plKill) {
        if (Util.isTrue(100, 100)) {
            ItemMap caitrangquylao = new ItemMap(this.zone, 710, 1, this.location.x,
        ...
        if (Util.isTrue(5, 100)) {
            ItemMap caitrangquylao2 = new ItemMap(this.zone, 710, 1, this.location.x,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap vang = new ItemMap(this.zone, 190, 30000, this.location.x + 20,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap vang2 = new ItemMap(this.zone, 190, 30000, this.location.x + 40,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap vang3 = new ItemMap(this.zone, 190, 30000, this.location.x + 60,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
        ...
        if (Util.isTrue(100, 100)) {
            ItemMap vang4 = new ItemMap(this.zone, 190, 30000, this.location.x + 80,
                    this.zone.map.yPhysicInTop(this.location.x,
                            this.location.y - 24),
                    plKill.id);
    ...
    public void doneChatE() {
        ...
        // for (Boss boss :
        // this.parentBoss.bossAppearTogether[this.parentBoss.currentLevel]) {
