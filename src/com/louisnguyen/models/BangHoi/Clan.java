package com.louisnguyen.models.BangHoi;
...
public class Clan {
    ...
    public long timeOpenGiaiCuuMiNuong;
    public Player playerOpenGiaiCuuMiNuong;
    ...
    public void sendFlagBagForAllMember() {
        for (Player pl : this.membersInGame) {
            if (pl != null) {
                ...
                Service.gI().sendTitle(pl, 60);
                Service.gI().sendTitle(pl, 66);
                Service.gI().sendTitle(pl, 64);
            }
        }
    }
    ...
    public void insert() {
        ...
        try (Connection con = GirlkunDB.getConnection();) {
            ...
            ps.setString(10, "[" + System.currentTimeMillis() + ",\"NroXuanHa\"]");
            ps.executeUpdate();
            ps.close();
        } catch (Exception e) {
