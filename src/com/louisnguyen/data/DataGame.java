...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "XH 01:127.0.0.1:14445";
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1143:11,1141:15, id : part (item_template)";
...
public static void effData(MySession session, int id, int... idtemp) {
    ...
    public static void sendLinkIP(MySession session) {
        ...
        try {
            msg = new Message(-29);
            msg.writer().writeByte(2);
            msg.writer().writeUTF(LINK_IP_PORT + ":0,0,0");
            msg.writer().writeByte(1);
            session.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
